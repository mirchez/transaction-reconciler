    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[95vw] sm:max-w-[700px] bg-white dark:bg-popover border-border rounded-none">
        <DialogHeader className="pb-4 sm:pb-6">
          <DialogTitle className="text-xl sm:text-2xl font-semibold text-foreground">Email Management</DialogTitle>
        ...
        <div className="mt-2">
          {!gmailStatus?.connected ? (
            <div className="bg-muted/50 rounded-none p-4 sm:p-8 border border-border">
              <div className="flex flex-col items-center text-center space-y-4 sm:space-y-6">
                ...
                <div className="space-y-2 sm:space-y-3">
                  <h3 className="text-lg sm:text-xl font-semibold text-foreground">Connect Gmail</h3>
                ...
                <Button 
                  ...
                  size="lg" 
                  className="rounded-none bg-primary hover:bg-primary/90 text-primary-foreground px-6 sm:px-8 text-sm sm:text-base w-full sm:w-auto"
                >
